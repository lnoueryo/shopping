  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          property: 'og:url',
          content: mode === 'production' ? 'https://webtech-bookstore.jounetsism.biz' : mode === 'stage' ? 'https://*webtech-bookstore-bff-stage-zycicxebda-an.a.run.app' : 'http://localhost:3000'
        },
        {
          property: 'og:image',
